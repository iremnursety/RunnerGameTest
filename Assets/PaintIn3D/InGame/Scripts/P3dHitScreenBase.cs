...
namespace PaintIn3D
{
	...
	public abstract class P3dHitScreenBase : MonoBehaviour
	{
		...
		private void CalcHitData(Vector3 hitPoint, Vector3 hitNormal, Ray ray, Camera camera, Vector2 screenPositionOld, out Vector3 finalPosition, out Quaternion finalRotation)
		{
